...
public enum GessenceType {
    ...
    MODIUM(new ResourceLocation(IgleeLib.MODID,"modium_ingot"),"modium",false,GeneratorType.NETHERITE),
    DERIUM(new ResourceLocation(IgleeLib.MODID,"derium_ingot"), "derium",true,GeneratorType.MODIUM),
    BLAZUM(new ResourceLocation(IgleeLib.MODID,"blazum_ingot"), "blazum",true,GeneratorType.DERIUM),
    LAVIUM(new ResourceLocation(IgleeLib.MODID,"lavium_ingot"), "lavium",true,GeneratorType.BLAZUM)
    ;
